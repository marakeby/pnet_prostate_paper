...
files.append(dict(Model ='Mutations with Hotspot adjusted',   file=join(base_dir,'onsplit_average_reg_10_tanh_large_testing_hotspot')))
...
mapping={'cnv_amp':'Amplification', 'cnv_del':'Deletion', 'mut_important':'Mutation', 'mut_important_plus_hotspots': 'Mutation', 'fusion_genes':'Fusion (genes)','fusion_indicator':'Fusion (indicator)'}
