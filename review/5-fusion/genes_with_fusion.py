...
# a= coef_df_dict[l]['Fusion (genes)'].abs().rank()
# b= coef_df_dict[l]['Fusion'].abs().rank()
genes_with_fusions = np.unique(['AFDN','ARHGAP5','BIRC6','CLTC','CUX1','EIF4A2','ERG','GNA11','HMGN2P46','KIAA1549','KLK2','NCOA2','NDRG1','NOTCH2','NSD1','RARA','SLC45A3','STAT3','SUZ12','TBL1XR1','TCF7L2','THRAP3','TMPRSS2','YWHAE','ATF1','BRAF','CALR','EML4','ERG','ETV1','ETV4','ETV5','FGFR2','FGFR4','HSP90AA1','KLF4','MLLT3','MYC','NF1','NSD3','PDE4DIP','PIK3CA','RPN1','SEPT9','SYK','TMPRSS2','VTI1A'])
